...
const menuItems = [
  ...
  {
    img: iceCream,
    caption: "Creamy Ice Cream Treats",
    description:
      "Indulge in creamy, dreamy ice cream with a range of delectable flavors and toppings.",
    price: "₹50",
    rating: "4.1",
  },
  {
  ...
  {
    img: dessert,
    caption: "Divine Dessert Delights",
    description:
      "Treat yourself to heavenly desserts, from decadent cakes to sweet pastries and more.",
    price: "₹80",
    rating: "4.8",
  },
];
